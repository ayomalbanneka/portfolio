    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
                ...
                <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScrolled ? "transition duration-200"
                    : "shadow-sm bg-white/50 backdrop-blur-lg transition duration-500 dark:border dark:border-white/50 dark:bg-transparent"}`}>
                ...
                bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-dark-hover dark:text-white'>
